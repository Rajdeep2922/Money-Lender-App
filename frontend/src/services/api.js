...
export const loanAPI = {
    ...
    previewCustomAgreement: (id, data) => api.post(`/loans/${id}/agreement/customized/preview`, data),
    approveCustomAgreement: (id, data) => api.post(`/loans/${id}/agreement/customized/approve`, data),
